...
1. Создать информационную систему позволяющую работать с сотрудниками некой компании \ студентами вуза \ учениками школы.

## Папка HomeWork8
**Содержит бот телеграмма на основе проекта Seminar8.**

1. Вывести программу онлайн (сделать на её основе бот в телеграмм). Вспомогательная ссылка : https://habr.com/ru/post/442800/